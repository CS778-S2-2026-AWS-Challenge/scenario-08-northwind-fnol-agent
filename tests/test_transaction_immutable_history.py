...
def test_agent_turn_rejects_paused_stored_session_without_partial_write() -> None:
    ...
    assert (
        repository.list_messages(claim.claim_id, paused_session.session_id, claim.customer_id) == []
    )
...
def test_agent_turn_rejects_non_current_session_without_partial_write() -> None:
    ...
    assert (
        repository.get_session(claim.claim_id, old_session.session_id, claim.customer_id)
        == old_session
    )
