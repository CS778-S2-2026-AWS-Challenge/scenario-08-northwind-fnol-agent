...
| `P3-METSERVICE` | Accepted with qualification | Historical weather reporting can support event evidence. S11 publishes report categories and starting prices, but it does not establish coverage, cause, liability, or claim acceptance; Northwind's selected product, final or custom quote, licence, procurement, and access form remain unresolved. | S11 |
...
| S11 | Accepted with qualification | Supports historical weather-report categories and published starting prices; does not establish a Northwind-selected product, final or custom quote, licence, procurement decision, claim decision, or Northwind access. |
...
| Observable external completion evidence | `P3-NZP-REPORT`, `P3-NZP-TCR`, `P3-VEHICLE-RECOVERY`, `P3-REPAIRER`, `P3-ASSESSOR`, `P3-EMERGENCY-WORKS`, `P3-FENZ-INFO`, `P3-METSERVICE`, `P3-NHC`, `P3-CONTENTS-EVIDENCE`, `P3-BROKER`, `P3-ACC-PROVIDER` | Unresolved | #588 co-owners | For each claim-journey participant, state what acknowledgement, accepted work, evidence receipt, verified result, and completion evidence are actually observable without inventing provider states. |
...
| MetService operating form | `P3-METSERVICE` | Unresolved | #588 co-owners | Preserve the public report categories and starting prices, then distinguish Northwind's selected product, final or custom quote, licence, procurement path, access form, and any simulation boundary. |
...
| Enabling-platform production access | `P3-EN-MESSAGING`, `P3-EN-DOC-AZURE`, `P3-EN-IDENTITY`, `P3-EN-ROUTES`, `P3-EN-MODEL`, `P3-EN-DOC-AWS`, `P3-EN-CONVERSATION`, `P3-EN-DAMAGE-AI` | Unresolved | #588 co-owners | Preserve unknown/unavailable/simulation-only access unless procurement, credentials, permitted data use, regional availability, and governance are evidenced. |
