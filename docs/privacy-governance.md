...
| ContentsItem | Describe claimed items without implying coverage | Claimant and staff Claim projections | Bounded active item context only | Optional brand/model and item-to-Evidence links belong to #922 |
