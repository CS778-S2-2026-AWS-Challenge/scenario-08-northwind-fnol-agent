...
- A successful multimodal Runtime trace may retain the exact selected Evidence ID, media type,
  ...
  payloads. Any proposed field derived from that attachment retains the Evidence ID as its source
  reference and remains unconfirmed until the ordinary fact-confirmation path accepts it.
